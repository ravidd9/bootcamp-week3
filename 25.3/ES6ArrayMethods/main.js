...
// ]
// const raiseSal = function(person){
//   if(person.goodPerformance){
//     person.salary +=300
//   }
// }
// people.forEach(raiseSal)
...
// let lower = messagesFromDad.map(m => m.toLowerCase())
// console.log(lower)
...
//   }
// ]
// const findCommentByID = function(postID, commID){
//   let p1 = posts.find(p => p.id === postID)
//   return p1.comments.find(c => c.id === commID)
// }
// console.log(findCommentByID(1, 0))


//some & every spot check
// let movies = [
...
let users = [
  ...
  //1
  // let u1 = users.map(m => {return {email: m.email,  companyName: m.company.name}})
  // console.log(u1)
  ...
  //3
  // let u3 = users.filter(u => u.address.zipcode[0] == 5).map(u => u.id)
  // console.log(u3)
  
  
  //4
  // let u4 = users.filter(u => u.name.startsWith('C')).map(u => u.name)
  // console.log(u4)
  ...
  //6
  // let u6 = users.find(u => u.address.suite === "Apt. 950")
  // console.log(u6.company.name)
